...
<div class="settings-value wpfTypeSwitchable wpfDependencyHidden" data-type="multi list" data-parent-switch="f_multi_collapsible">
	<div class="settings-value-label">
		<?php esc_html_e('Unfolding children', 'woo-product-filter'); ?>
		<i class="fa fa-question woobewoo-tooltip no-tooltip" title="<?php echo esc_attr__('When you select a parent filter category, all child nodes will be automatically opened.', 'woo-product-filter'); ?>"></i>
	</div>
	<?php HtmlWpf::checkboxToggle('f_multi_unfold_child', array()); ?>
</div>
<div class="settings-value wpfTypeSwitchable wpfDependencyHidden" data-type="multi list" data-parent-switch="f_multi_unfold_child">
	<div class="settings-value-label">
