 ...
 * CONFIG
 */
const themeFolder = "../html/wp-content/themes/ebikes/";
...
// const themePHPPath = [`${themeFolder}*.php`, `${themeFolder}**/*.php`];
 ...
 */
const themeStylePath = "./src/scss/style.scss";

const themeWatchStylePath = [
  themeStylePath,
  // ...[`${themeFolder}blocks/**/*.scss`],
  // ...[`${themeFolder}inc/scss/*.scss`],
  // ...[`${themeFolder}inc/scss/**/*.scss`],
  "src/scss/*.scss",
...
//   return gulp.watch(
//     [...blockStylePath, `${themeFolder}src/blocks/**/*.scss`],
//     gulp.series("build-block-sass")
//   );
// });
